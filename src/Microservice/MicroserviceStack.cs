  ...
  public class MicroserviceStack : Stack
  {
      ...
      :base(scope, id, props) 
    {
      ...
      var savePolicy = new Function(this, Id("savePolicy"), new FunctionProps
      {
        ...
        // VS2019/VS2022
        Code = Code.FromAsset(GetAssetPath("src/lambdas/SavePolicy/src/SavePolicy/bin/Debug/net8.0")),
      ...
      var readPolicy = new Function(this, Id("readPolicy"), new FunctionProps
      {
        ...
        // VS2019/VS2020
        Code = Code.FromAsset(GetAssetPath("src/lambdas/ReadPolicy/src/ReadPolicy/bin/Debug/net8.0")),
        Timeout = Duration.Seconds(15),
        Environment = new Dictionary<string, string>
        {
          ["TABLE"] = table.TableName
